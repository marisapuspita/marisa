    ...
    <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
     ...
     require 'koneksi.php';
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" name="tgl_pengaduan" value="<?php echo $data['tgl_pengaduan'];('d/m/Y'); ?>" class="form-control" readonly>
      </div>
      <div class="form-group cols-sm-6">
        <label>NIK</label>
      ...
      <div class="form-group cols-sm-6">
        ...
        <div> <img src="foto/<?php echo $data['foto']; ?> " width=device-width></div>
