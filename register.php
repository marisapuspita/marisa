                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    <div class="form-group">
                      <input type="text" name="nik" class="form-control form-control-user" placeholder="Masukan NIK">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     <input type="text" name="telp" class="form-control form-control-user" placeholder="Masukan No Telepon">
                    </div>

                    <div class="form-group">

                    </div>
                    <input type="submit" class="btn btn-info btn-user btn-block" value="Daftar!">
